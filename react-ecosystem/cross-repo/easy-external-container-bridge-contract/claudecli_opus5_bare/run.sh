#!/bin/zsh
# claudecli_opus5_bare — easy-external-container-bridge-contract
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-external-container-bridge-contract/claudecli_opus5_bare
CWD=/tmp/xrepo-runs/easy-external-container-bridge-contract-bare
...
echo "arm finished: easy-external-container-bridge-contract bare $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/easy-external-container-bridge-contract claudecli_opus5_bare"
