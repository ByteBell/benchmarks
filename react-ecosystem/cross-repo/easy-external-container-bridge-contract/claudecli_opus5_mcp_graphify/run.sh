#!/bin/zsh
# claudecli_opus5_mcp_graphify — easy-external-container-bridge-contract
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-external-container-bridge-contract/claudecli_opus5_mcp_graphify
...
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/easy-external-container-bridge-contract claudecli_opus5_mcp_graphify"
