#!/bin/zsh
# claudecli_opus5_mcp_plumbline — easy-external-container-bridge-contract
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-external-container-bridge-contract/claudecli_opus5_mcp_plumbline
CWD=/tmp/xrepo-runs/easy-external-container-bridge-contract-plumbline
...
[ -f /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-external-container-bridge-contract/golden.json ] || { echo "NO golden.json at /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-external-container-bridge-contract/golden.json - gate 4 cannot prove anything"; exit 1; }
sandbox-exec -f $PROFILE /bin/cat /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-external-container-bridge-contract/golden.json >/dev/null 2>&1 \
...
echo "arm finished: easy-external-container-bridge-contract plumbline $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/easy-external-container-bridge-contract claudecli_opus5_mcp_plumbline"
