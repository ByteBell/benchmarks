#!/bin/zsh
# claudecli_sonnet5_mcp_serena — easy-external-container-bridge-contract
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-external-container-bridge-contract/claudecli_sonnet5_mcp_serena
CWD=/tmp/xrepo-runs/easy-external-container-bridge-contract-serena
...
echo "arm finished: easy-external-container-bridge-contract serena $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/easy-external-container-bridge-contract claudecli_sonnet5_mcp_serena"
