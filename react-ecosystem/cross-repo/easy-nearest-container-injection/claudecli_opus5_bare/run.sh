#!/bin/zsh
# claudecli_opus5_bare — easy-nearest-container-injection
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-nearest-container-injection/claudecli_opus5_bare
...
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/easy-nearest-container-injection claudecli_opus5_bare"
