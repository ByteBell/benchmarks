#!/bin/zsh
# claudecli_opus5_mcp_plumbline — easy-nearest-container-injection
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-nearest-container-injection/claudecli_opus5_mcp_plumbline
CWD=/tmp/xrepo-runs/easy-nearest-container-injection-plumbline
...
[ -f /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-nearest-container-injection/golden.json ] || { echo "NO golden.json at /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-nearest-container-injection/golden.json - gate 4 cannot prove anything"; exit 1; }
sandbox-exec -f $PROFILE /bin/cat /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-nearest-container-injection/golden.json >/dev/null 2>&1 \
...
echo "arm finished: easy-nearest-container-injection plumbline $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/easy-nearest-container-injection claudecli_opus5_mcp_plumbline"
