#!/bin/zsh
# claudecli_opus5_mcp_serena — easy-nearest-container-injection
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-nearest-container-injection/claudecli_opus5_mcp_serena
CWD=/tmp/xrepo-runs/easy-nearest-container-injection-serena
...
echo "arm finished: easy-nearest-container-injection serena $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/easy-nearest-container-injection claudecli_opus5_mcp_serena"
