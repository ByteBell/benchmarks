#!/bin/zsh
# claudecli_sonnet5_bare — easy-nearest-container-injection
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-nearest-container-injection/claudecli_sonnet5_bare
CWD=/tmp/xrepo-runs/easy-nearest-container-injection-bare
...
echo "arm finished: easy-nearest-container-injection bare $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/easy-nearest-container-injection claudecli_sonnet5_bare"
