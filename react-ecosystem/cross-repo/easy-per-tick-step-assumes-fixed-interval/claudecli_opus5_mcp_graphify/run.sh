#!/bin/zsh
# claudecli_opus5_mcp_graphify — easy-per-tick-step-assumes-fixed-interval
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-per-tick-step-assumes-fixed-interval/claudecli_opus5_mcp_graphify
CWD=/tmp/xrepo-runs/easy-per-tick-step-assumes-fixed-interval-graphify
...
echo "arm finished: easy-per-tick-step-assumes-fixed-interval graphify $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/easy-per-tick-step-assumes-fixed-interval claudecli_opus5_mcp_graphify"
