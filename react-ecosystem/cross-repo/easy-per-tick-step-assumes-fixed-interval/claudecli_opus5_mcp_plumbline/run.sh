#!/bin/zsh
# claudecli_opus5_mcp_plumbline — easy-per-tick-step-assumes-fixed-interval
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-per-tick-step-assumes-fixed-interval/claudecli_opus5_mcp_plumbline
CWD=/tmp/xrepo-runs/easy-per-tick-step-assumes-fixed-interval-plumbline
...
[ -f /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-per-tick-step-assumes-fixed-interval/golden.json ] || { echo "NO golden.json at /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-per-tick-step-assumes-fixed-interval/golden.json - gate 4 cannot prove anything"; exit 1; }
sandbox-exec -f $PROFILE /bin/cat /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-per-tick-step-assumes-fixed-interval/golden.json >/dev/null 2>&1 \
...
echo "arm finished: easy-per-tick-step-assumes-fixed-interval plumbline $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/easy-per-tick-step-assumes-fixed-interval claudecli_opus5_mcp_plumbline"
