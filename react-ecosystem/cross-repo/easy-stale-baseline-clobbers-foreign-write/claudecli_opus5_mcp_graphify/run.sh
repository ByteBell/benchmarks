#!/bin/zsh
# claudecli_opus5_mcp_graphify — easy-stale-baseline-clobbers-foreign-write
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-stale-baseline-clobbers-foreign-write/claudecli_opus5_mcp_graphify
CWD=/tmp/xrepo-runs/easy-stale-baseline-clobbers-foreign-write-graphify
...
echo "arm finished: easy-stale-baseline-clobbers-foreign-write graphify $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/easy-stale-baseline-clobbers-foreign-write claudecli_opus5_mcp_graphify"
