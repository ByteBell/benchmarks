#!/bin/zsh
# claudecli_opus5_mcp_plumbline — easy-stale-baseline-clobbers-foreign-write
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-stale-baseline-clobbers-foreign-write/claudecli_opus5_mcp_plumbline
CWD=/tmp/xrepo-runs/easy-stale-baseline-clobbers-foreign-write-plumbline
...
[ -f /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-stale-baseline-clobbers-foreign-write/golden.json ] || { echo "NO golden.json at /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-stale-baseline-clobbers-foreign-write/golden.json - gate 4 cannot prove anything"; exit 1; }
sandbox-exec -f $PROFILE /bin/cat /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-stale-baseline-clobbers-foreign-write/golden.json >/dev/null 2>&1 \
...
echo "arm finished: easy-stale-baseline-clobbers-foreign-write plumbline $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/easy-stale-baseline-clobbers-foreign-write claudecli_opus5_mcp_plumbline"
