#!/bin/zsh
# claudecli_opus5_mcp_serena — easy-stale-baseline-clobbers-foreign-write
# a live language server over pre-registered serena projects.
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-stale-baseline-clobbers-foreign-write/claudecli_opus5_mcp_serena
CWD=/tmp/xrepo-runs/easy-stale-baseline-clobbers-foreign-write-serena
...
[ -f "/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/_indexes/serena_mcp/mcp_serena.json" ] || { echo "MISSING: /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/_indexes/serena_mcp/mcp_serena.json"; exit 1; }
...
( cd $CWD && sandbox-exec -f $PROFILE "$CLAUDE" -p "$(cat $ARM/run_prompt.txt)" \
    ...
    --mcp-config "/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/_indexes/serena_mcp/mcp_serena.json" --strict-mcp-config \
    --allowedTools "mcp__serena__activate_project" "mcp__serena__find_symbol" "mcp__serena__find_referencing_symbols" "mcp__serena__find_declaration" "mcp__serena__find_implementations" "mcp__serena__get_symbols_overview" "mcp__serena__get_diagnostics_for_file" "mcp__serena__search_for_pattern" "mcp__serena__read_file" "mcp__serena__list_dir" "mcp__serena__find_file" \
...
echo "arm finished: easy-stale-baseline-clobbers-foreign-write serena $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/easy-stale-baseline-clobbers-foreign-write claudecli_opus5_mcp_serena"
