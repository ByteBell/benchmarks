#!/bin/zsh
# claudecli_opus5_bare — easy-xrepo-v5-2-custom-comparison-rerender-gate
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-xrepo-v5-2-custom-comparison-rerender-gate/claudecli_opus5_bare
...
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/easy-xrepo-v5-2-custom-comparison-rerender-gate claudecli_opus5_bare"
