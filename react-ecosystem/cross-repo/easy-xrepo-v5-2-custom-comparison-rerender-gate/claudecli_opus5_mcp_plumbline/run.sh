#!/bin/zsh
# claudecli_opus5_mcp_plumbline — easy-xrepo-v5-2-custom-comparison-rerender-gate
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-xrepo-v5-2-custom-comparison-rerender-gate/claudecli_opus5_mcp_plumbline
CWD=/tmp/xrepo-runs/easy-xrepo-v5-2-custom-comparison-rerender-gate-plumbline
...
[ -f /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-xrepo-v5-2-custom-comparison-rerender-gate/golden.json ] || { echo "NO golden.json at /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-xrepo-v5-2-custom-comparison-rerender-gate/golden.json - gate 4 cannot prove anything"; exit 1; }
sandbox-exec -f $PROFILE /bin/cat /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-xrepo-v5-2-custom-comparison-rerender-gate/golden.json >/dev/null 2>&1 \
...
echo "arm finished: easy-xrepo-v5-2-custom-comparison-rerender-gate plumbline $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/easy-xrepo-v5-2-custom-comparison-rerender-gate claudecli_opus5_mcp_plumbline"
