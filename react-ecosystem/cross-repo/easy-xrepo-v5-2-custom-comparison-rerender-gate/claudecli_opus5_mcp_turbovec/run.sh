#!/bin/zsh
# claudecli_opus5_mcp_turbovec — easy-xrepo-v5-2-custom-comparison-rerender-gate
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-xrepo-v5-2-custom-comparison-rerender-gate/claudecli_opus5_mcp_turbovec
CWD=/tmp/xrepo-runs/easy-xrepo-v5-2-custom-comparison-rerender-gate-turbovec
...
echo "arm finished: easy-xrepo-v5-2-custom-comparison-rerender-gate turbovec $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/easy-xrepo-v5-2-custom-comparison-rerender-gate claudecli_opus5_mcp_turbovec"
