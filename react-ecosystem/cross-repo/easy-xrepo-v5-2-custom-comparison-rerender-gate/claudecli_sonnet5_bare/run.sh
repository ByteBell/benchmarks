#!/bin/zsh
# claudecli_sonnet5_bare — easy-xrepo-v5-2-custom-comparison-rerender-gate
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/easy-xrepo-v5-2-custom-comparison-rerender-gate/claudecli_sonnet5_bare
CWD=/tmp/xrepo-runs/easy-xrepo-v5-2-custom-comparison-rerender-gate-bare
...
echo "arm finished: easy-xrepo-v5-2-custom-comparison-rerender-gate bare $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/easy-xrepo-v5-2-custom-comparison-rerender-gate claudecli_sonnet5_bare"
