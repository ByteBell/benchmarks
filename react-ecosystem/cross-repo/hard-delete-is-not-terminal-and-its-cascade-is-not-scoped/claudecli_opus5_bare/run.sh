#!/bin/zsh
# claudecli_opus5_bare — hard-delete-is-not-terminal-and-its-cascade-is-not-scoped
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-delete-is-not-terminal-and-its-cascade-is-not-scoped/claudecli_opus5_bare
CWD=/tmp/xrepo-runs/hard-delete-is-not-terminal-and-its-cascade-is-not-scoped-bare
...
echo "arm finished: hard-delete-is-not-terminal-and-its-cascade-is-not-scoped bare $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/hard-delete-is-not-terminal-and-its-cascade-is-not-scoped claudecli_opus5_bare"
