#!/bin/zsh
# claudecode_opus5_plumbline — hard-delete-is-not-terminal-and-its-cascade-is-not-scoped
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-delete-is-not-terminal-and-its-cascade-is-not-scoped/claudecode_opus5_plumbline
...
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/hard-delete-is-not-terminal-and-its-cascade-is-not-scoped claudecode_opus5_plumbline"
