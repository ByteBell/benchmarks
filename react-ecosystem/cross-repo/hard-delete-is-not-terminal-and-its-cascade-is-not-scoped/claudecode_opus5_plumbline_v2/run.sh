#!/bin/zsh
# claudecode_opus5_plumbline_v2 — hard-delete-is-not-terminal-and-its-cascade-is-not-scoped
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-delete-is-not-terminal-and-its-cascade-is-not-scoped/claudecode_opus5_plumbline_v2
CWD=/tmp/xrepo-runs/hard-delete-is-not-terminal-and-its-cascade-is-not-scoped-plumbline
...
[ -f /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-delete-is-not-terminal-and-its-cascade-is-not-scoped/golden.json ] || { echo "NO golden.json at /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-delete-is-not-terminal-and-its-cascade-is-not-scoped/golden.json - gate 4 cannot prove anything"; exit 1; }
sandbox-exec -f $PROFILE /bin/cat /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-delete-is-not-terminal-and-its-cascade-is-not-scoped/golden.json >/dev/null 2>&1 \
...
echo "arm finished: hard-delete-is-not-terminal-and-its-cascade-is-not-scoped plumbline $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/hard-delete-is-not-terminal-and-its-cascade-is-not-scoped claudecode_opus5_plumbline_v2"
