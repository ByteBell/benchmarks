#!/bin/zsh
# claudecli_opus5_mcp_plumbline — hard-failed-first-load-is-a-one-way-door
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-failed-first-load-is-a-one-way-door/claudecli_opus5_mcp_plumbline
CWD=/tmp/xrepo-runs/hard-failed-first-load-is-a-one-way-door-plumbline
...
[ -f /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-failed-first-load-is-a-one-way-door/golden.json ] || { echo "NO golden.json at /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-failed-first-load-is-a-one-way-door/golden.json - gate 4 cannot prove anything"; exit 1; }
sandbox-exec -f $PROFILE /bin/cat /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-failed-first-load-is-a-one-way-door/golden.json >/dev/null 2>&1 \
...
echo "arm finished: hard-failed-first-load-is-a-one-way-door plumbline $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/hard-failed-first-load-is-a-one-way-door claudecli_opus5_mcp_plumbline"
