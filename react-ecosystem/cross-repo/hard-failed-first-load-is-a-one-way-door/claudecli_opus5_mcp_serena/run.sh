#!/bin/zsh
# claudecli_opus5_mcp_serena — hard-failed-first-load-is-a-one-way-door
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-failed-first-load-is-a-one-way-door/claudecli_opus5_mcp_serena
CWD=/tmp/xrepo-runs/hard-failed-first-load-is-a-one-way-door-serena
...
echo "arm finished: hard-failed-first-load-is-a-one-way-door serena $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/hard-failed-first-load-is-a-one-way-door claudecli_opus5_mcp_serena"
