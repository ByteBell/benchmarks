#!/bin/zsh
# claudecli_sonnet5_graphify — hard-failed-first-load-is-a-one-way-door
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-failed-first-load-is-a-one-way-door/claudecli_sonnet5_graphify
...
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/hard-failed-first-load-is-a-one-way-door claudecli_sonnet5_graphify"
