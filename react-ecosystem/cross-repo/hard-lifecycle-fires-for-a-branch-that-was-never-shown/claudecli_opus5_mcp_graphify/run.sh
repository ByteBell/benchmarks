#!/bin/zsh
# claudecli_opus5_mcp_graphify — hard-lifecycle-fires-for-a-branch-that-was-never-shown
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-lifecycle-fires-for-a-branch-that-was-never-shown/claudecli_opus5_mcp_graphify
CWD=/tmp/xrepo-runs/hard-lifecycle-fires-for-a-branch-that-was-never-shown-graphify
...
echo "arm finished: hard-lifecycle-fires-for-a-branch-that-was-never-shown graphify $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/hard-lifecycle-fires-for-a-branch-that-was-never-shown claudecli_opus5_mcp_graphify"
