#!/bin/zsh
# claudecli_opus5_mcp_graphify — hard-one-effect-two-doors-only-one-guarded
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-one-effect-two-doors-only-one-guarded/claudecli_opus5_mcp_graphify
CWD=/tmp/xrepo-runs/hard-one-effect-two-doors-only-one-guarded-graphify
...
[ -f "/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/_indexes/graphify/merged/graphify-out/graph.json" ] || { echo "MISSING: /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/_indexes/graphify/merged/graphify-out/graph.json"; exit 1; }
[ -f "/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/_indexes/graphify_mcp/mcp_graphify.json" ] || { echo "MISSING: /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/_indexes/graphify_mcp/mcp_graphify.json"; exit 1; }
...
( cd $CWD && sandbox-exec -f $PROFILE "$CLAUDE" -p "$(cat $ARM/run_prompt.txt)" \
    ...
    --mcp-config "/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/_indexes/graphify_mcp/mcp_graphify.json" --strict-mcp-config \
...
echo "arm finished: hard-one-effect-two-doors-only-one-guarded graphify $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/hard-one-effect-two-doors-only-one-guarded claudecli_opus5_mcp_graphify"
