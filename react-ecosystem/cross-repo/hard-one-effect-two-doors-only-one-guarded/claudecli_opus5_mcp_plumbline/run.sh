#!/bin/zsh
# claudecli_opus5_mcp_plumbline — hard-one-effect-two-doors-only-one-guarded
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-one-effect-two-doors-only-one-guarded/claudecli_opus5_mcp_plumbline
...
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/hard-one-effect-two-doors-only-one-guarded claudecli_opus5_mcp_plumbline"
