#!/bin/zsh
# claudecli_opus5_mcp_serena — hard-one-effect-two-doors-only-one-guarded
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-one-effect-two-doors-only-one-guarded/claudecli_opus5_mcp_serena
CWD=/tmp/xrepo-runs/hard-one-effect-two-doors-only-one-guarded-serena
...
echo "arm finished: hard-one-effect-two-doors-only-one-guarded serena $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/hard-one-effect-two-doors-only-one-guarded claudecli_opus5_mcp_serena"
