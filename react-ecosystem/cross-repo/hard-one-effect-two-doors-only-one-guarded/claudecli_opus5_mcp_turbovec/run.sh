#!/bin/zsh
# claudecli_opus5_mcp_turbovec — hard-one-effect-two-doors-only-one-guarded
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-one-effect-two-doors-only-one-guarded/claudecli_opus5_mcp_turbovec
CWD=/tmp/xrepo-runs/hard-one-effect-two-doors-only-one-guarded-turbovec
...
echo "arm finished: hard-one-effect-two-doors-only-one-guarded turbovec $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/hard-one-effect-two-doors-only-one-guarded claudecli_opus5_mcp_turbovec"
