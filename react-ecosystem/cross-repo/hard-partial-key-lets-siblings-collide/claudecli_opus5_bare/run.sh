#!/bin/zsh
# claudecli_opus5_bare — hard-partial-key-lets-siblings-collide
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-partial-key-lets-siblings-collide/claudecli_opus5_bare
CWD=/tmp/xrepo-runs/hard-partial-key-lets-siblings-collide-bare
...
echo "arm finished: hard-partial-key-lets-siblings-collide bare $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/hard-partial-key-lets-siblings-collide claudecli_opus5_bare"
