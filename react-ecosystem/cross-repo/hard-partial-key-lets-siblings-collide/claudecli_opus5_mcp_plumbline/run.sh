#!/bin/zsh
# claudecli_opus5_mcp_plumbline — hard-partial-key-lets-siblings-collide
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-partial-key-lets-siblings-collide/claudecli_opus5_mcp_plumbline
CWD=/tmp/xrepo-runs/hard-partial-key-lets-siblings-collide-plumbline
...
[ -f /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-partial-key-lets-siblings-collide/golden.json ] || { echo "NO golden.json at /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-partial-key-lets-siblings-collide/golden.json - gate 4 cannot prove anything"; exit 1; }
sandbox-exec -f $PROFILE /bin/cat /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-partial-key-lets-siblings-collide/golden.json >/dev/null 2>&1 \
...
echo "arm finished: hard-partial-key-lets-siblings-collide plumbline $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/hard-partial-key-lets-siblings-collide claudecli_opus5_mcp_plumbline"
