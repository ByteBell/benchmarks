#!/bin/zsh
# claudecli_opus5_mcp_turbovec — hard-partial-key-lets-siblings-collide
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/hard-partial-key-lets-siblings-collide/claudecli_opus5_mcp_turbovec
CWD=/tmp/xrepo-runs/hard-partial-key-lets-siblings-collide-turbovec
...
echo "arm finished: hard-partial-key-lets-siblings-collide turbovec $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/hard-partial-key-lets-siblings-collide claudecli_opus5_mcp_turbovec"
