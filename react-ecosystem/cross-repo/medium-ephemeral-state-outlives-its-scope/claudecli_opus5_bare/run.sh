#!/bin/zsh
# claudecli_opus5_bare — medium-ephemeral-state-outlives-its-scope
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/medium-ephemeral-state-outlives-its-scope/claudecli_opus5_bare
CWD=/tmp/xrepo-runs/medium-ephemeral-state-outlives-its-scope-bare
...
echo "arm finished: medium-ephemeral-state-outlives-its-scope bare $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/medium-ephemeral-state-outlives-its-scope claudecli_opus5_bare"
