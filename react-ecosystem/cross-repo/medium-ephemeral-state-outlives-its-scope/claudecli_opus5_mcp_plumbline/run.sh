#!/bin/zsh
# claudecli_opus5_mcp_plumbline — medium-ephemeral-state-outlives-its-scope
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/medium-ephemeral-state-outlives-its-scope/claudecli_opus5_mcp_plumbline
CWD=/tmp/xrepo-runs/medium-ephemeral-state-outlives-its-scope-plumbline
...
[ -f /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/medium-ephemeral-state-outlives-its-scope/golden.json ] || { echo "NO golden.json at /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/medium-ephemeral-state-outlives-its-scope/golden.json - gate 4 cannot prove anything"; exit 1; }
sandbox-exec -f $PROFILE /bin/cat /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/medium-ephemeral-state-outlives-its-scope/golden.json >/dev/null 2>&1 \
...
echo "arm finished: medium-ephemeral-state-outlives-its-scope plumbline $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/medium-ephemeral-state-outlives-its-scope claudecli_opus5_mcp_plumbline"
