#!/bin/zsh
# claudecli_opus5_mcp_turbovec — medium-ephemeral-state-outlives-its-scope
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/medium-ephemeral-state-outlives-its-scope/claudecli_opus5_mcp_turbovec
CWD=/tmp/xrepo-runs/medium-ephemeral-state-outlives-its-scope-turbovec
...
echo "arm finished: medium-ephemeral-state-outlives-its-scope turbovec $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/medium-ephemeral-state-outlives-its-scope claudecli_opus5_mcp_turbovec"
