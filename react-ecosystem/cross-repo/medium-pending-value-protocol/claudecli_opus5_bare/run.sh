#!/bin/zsh
# claudecli_opus5_bare — medium-pending-value-protocol
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/medium-pending-value-protocol/claudecli_opus5_bare
...
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/medium-pending-value-protocol claudecli_opus5_bare"
