#!/bin/zsh
# claudecli_opus5_mcp_graphify — medium-pending-value-protocol
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/medium-pending-value-protocol/claudecli_opus5_mcp_graphify
CWD=/tmp/xrepo-runs/medium-pending-value-protocol-graphify
...
echo "arm finished: medium-pending-value-protocol graphify $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/medium-pending-value-protocol claudecli_opus5_mcp_graphify"
