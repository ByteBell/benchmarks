#!/bin/zsh
# claudecli_opus5_mcp_plumbline — medium-pending-value-protocol
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/medium-pending-value-protocol/claudecli_opus5_mcp_plumbline
CWD=/tmp/xrepo-runs/medium-pending-value-protocol-plumbline
...
[ -f /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/medium-pending-value-protocol/golden.json ] || { echo "NO golden.json at /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/medium-pending-value-protocol/golden.json - gate 4 cannot prove anything"; exit 1; }
sandbox-exec -f $PROFILE /bin/cat /Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/medium-pending-value-protocol/golden.json >/dev/null 2>&1 \
...
echo "arm finished: medium-pending-value-protocol plumbline $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/medium-pending-value-protocol claudecli_opus5_mcp_plumbline"
