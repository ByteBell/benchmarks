#!/bin/zsh
# claudecli_opus5_mcp_turbovec — medium-pending-value-protocol
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/medium-pending-value-protocol/claudecli_opus5_mcp_turbovec
CWD=/tmp/xrepo-runs/medium-pending-value-protocol-turbovec
...
echo "arm finished: medium-pending-value-protocol turbovec $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/medium-pending-value-protocol claudecli_opus5_mcp_turbovec"
