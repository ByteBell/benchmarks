#!/bin/zsh
# claudecli_sonnet5_bare — medium-pending-value-protocol
...
set -e
ARM=/Users/sauravverma/programs/benchmarks/react-ecosystem/cross-repo/medium-pending-value-protocol/claudecli_sonnet5_bare
CWD=/tmp/xrepo-runs/medium-pending-value-protocol-bare
...
echo "arm finished: medium-pending-value-protocol bare $(cat $ARM/wall.txt)"
echo
echo "next: python3 /Users/sauravverma/programs/benchmarks/react-ecosystem/score_arm.py cross-repo/medium-pending-value-protocol claudecli_sonnet5_bare"
